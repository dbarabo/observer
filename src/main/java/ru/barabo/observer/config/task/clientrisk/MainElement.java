...
public class MainElement {
    ...
    @XStreamAsAttribute
    @XStreamAlias("xmlns")
    final String xmlns = "urn:cbr-ru:e-forms-mf-form-KYC:v0.0.11";

    @XStreamAsAttribute
    @XStreamAlias("xsi:schemaLocation")
    final String schemaLocation = "urn:cbr-ru:e-forms-mf-form-KYC:v0.0.11 schema.xsd";
