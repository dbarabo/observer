...
public class FlEvent2_5 extends AbstractEventData {
    ...
    @XStreamAlias("FL_38_ContractEnd")
    final Fl38ContractEnd fl38ContractEnd; // Блок 20. Сведения о солидарных должниках
    ...
    public FlEvent2_5(Integer orderNum, Date eventDate, Fl17DealUid fl17DealUid, Fl18Deal fl18Deal,
    ...
    public Fl38ContractEnd getFl38ContractEnd() {
        return fl38ContractEnd;
    }
