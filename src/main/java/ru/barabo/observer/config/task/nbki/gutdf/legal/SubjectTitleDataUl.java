...
public class SubjectTitleDataUl {
    ...
    private final Ul3Reg ul3Reg; // minOccurs="0" Блок 3. Регистрационный номер

    @XStreamAlias("UL_4_Tax")
    private final Ul4Tax ul4Tax;  // minOccurs="0" Блок 4. Номер налогоплательщика
    ...
    public SubjectTitleDataUl(Ul1Name ul1Name, Ul2Address ul2Address,
                              Ul3Reg ul3Reg, Ul4Tax ul4Tax, List<Ul5Reorg> ul5ReorgList) {
