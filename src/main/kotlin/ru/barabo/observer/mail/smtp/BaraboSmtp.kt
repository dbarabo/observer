...
object BaraboSmtp : SendMail {
    ...
    val CHECKER_CBR_RISK =  arrayOf("oper@ptkb.ru").onlyAfinaOrYa()
    ...
    val MANAGERS_UOD = arrayOf("ursu@ptkb.ru").onlyAfina()

    val MANAGERS_SVK = arrayOf("yanushkevich@ptkb.ru", "okina@ptkb.ru").onlyAfina()
