...
object NewMantisConnect : DbConnection(
    DbSetting("org.firebirdsql.jdbc.FBDriver",
        "jdbc:firebirdsql://192.168.0.27:3050/c:/percoBD/BD/SCD17K.FDB?encoding=UNICODE_FSS",//"jdbc:mysql://192.168.0.26:3306/bugtracker?useUnicode=true&characterEncoding=UTF-8",
        "SYSDBA",
        "masterke",
