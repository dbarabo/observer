...
object Load101FormXml : FileFinder, FileProcessor {
    ...
    override val fileFinderData: List<FileFinderData> =
           // listOf(FileFinderData(TicketXml::ptkPostStore, "Ф101_40507717\\.xml\\.cab\\.\\d\\d\\d\\d\\d\\d") )
            listOf(FileFinderData(::xReceiptTodayFolder, "Ф101_40507717\\.xml", false, true))
    ...
    override fun processFile(file: File) {
        ...
        //val (xml101) = Archive.extractFromCab(file, tempFolder.absolutePath, "Ф101_40507717\\.xml")!!

        val xml101 = file

        val textXml = xml101.readText(Charset.forName("CP1251"))
