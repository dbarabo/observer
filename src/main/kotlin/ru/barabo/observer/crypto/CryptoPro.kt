...
private fun baraboCertificateData(): CertificateData = CertificateData("shirokov@ptkb.ru", "support@nbki.ru", listOf("support@nbki.ru") )

private fun jzdoCertificateData(): CertificateData = CertificateData("Kolpakov@ptkb.ru"/*"yeti@ptkb.ru"*/, "e.krivonosov@cft.ru",
